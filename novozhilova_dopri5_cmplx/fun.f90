module fun
    ...
    real(c_double) zex, dz, tend, dtr(2), q(3), i(2), th(2), a(2), dcir(2), r(2), f0(3), dt, &
        ...
        x2r, x2i, q32, i2, r2, th2, dcir2, cos2, sin2, q3, a1, a2
...
102     print *, 'error of reading file "input_fortran.in"'; pause; stop
    ...
    subroutine dpdz(neqp, z, p, prhs, rparp, iparp)
        ...
        do i = 1, 2
            ...
            s = ic*(fp(i)*u - (dtr(i) + cdabs(ptmp)**2 - 1)*ptmp)
...
10          continue
    ...
    function dfdtcmplx(fcmplx) result(s)
        ...
        s(1) = (ic*i1*x1 - fcmplx(1))*q31 + 2*r1*q31*cdexp(-ic*th1)*fcmplx(3) - ic*dcir1*2*q3*fcmplx(1)
        s(2) = (ic*i2*x2 - fcmplx(2))*q32 + 2*r2*q32*cdexp(-ic*th2)*fcmplx(3) - ic*dcir2*2*q3*fcmplx(2)
